...
## Barro Colorado Island {.columns-2}
...
## Accumulation de la diversité {.flexbox .vcenter}

Raisonnement identique pour la diversité de Shannon
...
-   Richesse : Chao ou Jacknife
-   Entropie HCDT :
    -   Réduction du biais d'estimation
    -   Estimation de la distribution réelle

## Diversité aymptotique

En pratique : package divent
...
Phylogénie dans l'idéal, taxonomie possible.

## Définition

L'entropie est l'information moyenne au cours du temps.

## Application

Profil de diversité de Paracou, basé sur la taxonomie.
...
-   Diversité $\beta$ : entre les communautés. Ratio $\gamma / \alpha$ ou différence $\gamma - \alpha$
