...
@Whittaker1960 : plusieurs communautés regroupées dans une métacommunauté dont les communautés sont des échantillons. La diversité est la richesse (entropie et diversité).
...
-   La diversité $\beta$ est un nombre effectif de communautés : communautés de même poids, sans aucune espèce commune
...
En pratique : package [divent](https://ericmarcon.github.io/divent/)
